...
namespace BlazorAppEcom.Server.Migrations
{
    ...
    [Migration("20230206063639_orderaddress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorAppEcom.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAppEcom.Shared.OrderItem", b =>
                {
                    ...
                    b.HasKey("OrderId", "ProductTypeId", "productId");
            ...
            modelBuilder.Entity("BlazorAppEcom.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAppEcom.Shared.ProductVariant", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorAppEcom.Shared.Order", b =>
                {
                    b.HasOne("BlazorAppEcom.Shared.Addresses", "address")
                        .WithMany()
            ...
            modelBuilder.Entity("BlazorAppEcom.Shared.OrderItem", b =>
                {
                    ...
                    b.HasOne("BlazorAppEcom.Shared.ProductType", "ProductType")
                        .WithMany()
                        .HasForeignKey("ProductTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorAppEcom.Shared.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("BlazorAppEcom.Shared.Product", b =>
                {
                    b.HasOne("BlazorAppEcom.Shared.Category", "Category")
                        .WithMany()
